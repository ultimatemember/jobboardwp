...
if ( ! class_exists( 'jb\frontend\Enqueue' ) ) {
	...
	class Enqueue extends \jb\common\Enqueue {
		...
		function register_scripts() {
			...
			wp_register_script( 'jb-job-categories', $this->js_url['frontend'] . 'job-categories' . JB()->scrips_prefix . '.js', [ 'jb-front-global' ], jb_version, true );
			...
			wp_register_style( 'jb-job-categories', $this->css_url['frontend'] . 'job-categories' . JB()->scrips_prefix . '.css', [ 'jb-common' ], jb_version );
